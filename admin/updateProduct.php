...
if(isset($_POST['changebook'])) {
		...
		$query="update `product` set name='$name', author='$author', ratings='$ratings', reviews='$reviews', price='$price', discount='$discount', quantityAvailable='$quantity', ISBN='$ISBN', country='$country', language='$language', series='$series', type='$type', publisher='$publisher', edition='$edition', pages='$pages', description='$description' where productId='$productId'";
		mysqli_query($link,$query) or die("Error updating data.".mysqli_error($link));
		
		$messagebook="Note: $name has been updated!";
}		
		...
		$bookdetail['name'] = $bookdetail['author'] = $bookdetail['ratings'] = $bookdetail['reviews'] = $bookdetail['price'] = $bookdetail['discount'] = $bookdetail['quantityAvailable'] = $bookdetail['ISBN'] = $bookdetail['country'] = $bookdetail['language'] = $bookdetail['series'] = $bookdetail['type']= $bookdetail['publisher'] = $bookdetail['edition'] = $bookdetail['pages'] = $bookdetail['services'] = $bookdetail['formats'] = $bookdetail['description']= "";
		
		if(isset($_POST['selectbook'])){
			
			$productId=$_POST['selectbookname'];
			$query3="select * from product where productId='$productId'";
			$result=mysqli_query($link,$query3) or die("Error fetching data.".mysqli_error($link));
			$bookdetail=mysqli_fetch_assoc($result);
...
<main class="col-sm-9 offset-sm-3 col-md-10 offset-md-2 pt-3">
	<h4 class="text-right">Welcome <?php echo $aname;?></h4>
		...
		<div class="row">
			<div class="col-sm-6">
				<h3 class="text-material-red">Update Product</h3>
			</div>
			<div class="col-sm-6">
				<h5 class="text-material-green rob-regular"><?php echo $messagebook;?></h5>
			</div>
		</div>
		<hr/>
	<h4 class="text-material-red rob-regular">1. Product Details</h4>
	<hr/>
	<form method="POST" name="sellectbook">
	<div class="row" id="changeDetails">
				<div class="col-md-6">
					<div class="form-group row">
					  <label for="example-text-input" class="col-2 col-form-label">Select</label>
					  <div class="col-6">
					  <select class="form-control" name="selectbookname" id="exampleSelect1">
						  <option value="0">---select book name---</option>
					  <?php
						$query1="SELECT productId, name from product";
						$result=mysqli_query($link,$query1) or die("Error updating data.".mysqli_error($link));
						while($bookname=mysqli_fetch_assoc($result)){
							echo '<option value="';
							echo $bookname['productId'] ;
							echo '">';
							echo $bookname['productId'];
							echo ". ";
							echo $bookname['name'];
				...
				<div class="col-md-6 p-0 col-md-offset-1"><!--Product Image-->
						<div class="form-group ">
							<button type="submit" class="btn btn-primary" id="profilePhotoBtn" name="selectbook">Submit</button>
						</div>
				</div>
			</div>
		</form>
	...
	<div class="container">
		<form method="post" class="rob-regular">
			<div class="row" id="changeDetails">
				<div class="col-md-6">
					<div class="form-group row">
					  ...
					  <div class="col-10">
						<input class="form-control" type="text" name="name"value="<?php echo $bookdetail['name'];?>" id="example-text-input" required>
					  </div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group row">
					  ...
					  <div class="col-10">
						<input class="form-control" type="text" name="author" value="<?php echo $bookdetail['author'];?>" id="example-text-input">
					  </div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group row">
					  ...
					  <div class="col-10">
						<input class="form-control" type="text" name="ratings" value="<?php echo $bookdetail['ratings'];?>" id="example-text-input">
					  </div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group row">
					  ...
					  <div class="col-10">
						<input class="form-control" type="text" name="reviews" value="<?php echo $bookdetail['reviews'];?>" id="example-text-input">
					  </div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group row">
					  ...
					  <div class="col-10">
						<input class="form-control" type="text" name="price" value="<?php echo $bookdetail['price'];?>" id="example-text-input">
					  </div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group row">
					  ...
					  <div class="col-10">
						<input class="form-control" type="text" name="discount" value="<?php echo $bookdetail['discount'];?>" id="example-text-input">
					  </div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group row">
					  ...
					  <div class="col-10">
						<input class="form-control" type="text" name="quantity" value="<?php echo $bookdetail['quantityAvailable'];?>" id="example-text-input">
					  </div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group row">
					  ...
					  <div class="col-10">
						<input class="form-control" type="text" name="ISBN" value="<?php echo $bookdetail['ISBN'];?>" id="example-text-input">
					  </div>
					</div>
				</div>
				<div class="col-md-6">
				...
				<div class="col-md-6">
					<div class="form-group row">
					  ...
					  <div class="col-10">
						<input class="form-control" name="series" type="text" value="<?php echo $bookdetail['series'];?>" id="example-text-input">
					  </div>
					</div>
				</div>
				<div class="col-md-6">
				...
				<div class="col-md-6">
					<div class="form-group row">
					  ...
					  <div class="col-10">
						<input class="form-control" name="publisher" type="text" value="<?php echo $bookdetail['publisher'];?>" id="example-text-input">
					  </div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group row">
					  ...
					  <div class="col-10">
						<input class="form-control" name="edition" type="text" value="<?php echo $bookdetail['edition'];?>" id="example-text-input">
					  </div>
					</div>
				</div>
				<div class="col-md-6">
					<div class="form-group row">
					  ...
					  <div class="col-10">
						<input class="form-control" name="pages" type="text" value="<?php echo $bookdetail['pages'];?>" id="example-text-input">
					  </div>
					</div>
				</div>
				<div class="col-md-6">
			...
			<hr/>	
			<input type="hidden" value="<?php echo $bookdetail['productId'];?>" name="pid"/>
				  <div class="form-group row">
					  <label for="example-text-input" class="rob-regular col-2 col-form-label">Description</label>
					  <div class="col-10">
						<textarea style="resize: none;" name="description" class="form-control" name="description" id="exampleTextarea" rows="5"><?php echo $bookdetail['description'];?></textarea>
					  </div>
					</div>
			</div>
			...
			<div class="form-group clearfix">
				<button type="submit" class="btn btn-block" name="changebook">Update</button>
			</div>
			</form>
